...
public class kafkaConsumer extends Thread{
    ...
    private ConsumerConnector createConsumer() {
        ...
        properties.put("zookeeper.connect", "localhost:2181/kafka,localhost:2182/kafka,localhost:2183/kafka");//声明zk
    ...
    public static void main(String[] args) {
        new kafkaConsumer("test-topic").start();// 使用kafka集群中创建好的主题 test-topic
    }
}
